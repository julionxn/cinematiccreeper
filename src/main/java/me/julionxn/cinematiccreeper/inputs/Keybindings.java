...
public class Keybindings {
    ...
    public static final String KEY_CHANGE_SKIN = "key.cinematiccreeper.change_skin";
    ...
    public static KeyBinding changeSkin;
    ...
    public static void register() {
        ...
        changeSkin = KeyBindingHelper.registerKeyBinding(new KeyBinding(
                KEY_CHANGE_SKIN,
                InputUtil.Type.KEYSYM,
                GLFW.GLFW_KEY_I,
                KEY_CATEGORY_CINEMATICCREEPER
